        ...
        <div className="detail-modal-backdrop" onClick={() => setIsDetailModalOpen(false)}>
            <div className="detail-modal-card" onClick={e => e.stopPropagation()}>
                ...
                <div className="detail-modal-footer">
                    <button className="detail-btn-primary" onClick={() => window.location.href = selectedEvent.type === 'BOOKING' ? '/admin/bookings' : '/admin/classes'}>Edit</button>
                    <button className="detail-btn-secondary" onClick={() => window.location.href = selectedEvent.type === 'BOOKING' ? '/admin/bookings' : '/admin/classes'}>Go to List</button>
                </div>
            </div>
        </div>
      )}
