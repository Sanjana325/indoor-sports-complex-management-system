...
router.delete("/admin/sports/:sportId", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), adminController.deleteSport);

router.get("/admin/courts", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), adminController.listCourts);
router.post("/admin/courts", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), adminController.createCourt);
router.put("/admin/courts/:courtId", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), adminController.updateCourt);
router.delete("/admin/courts/:courtId", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), adminController.deleteCourt);
